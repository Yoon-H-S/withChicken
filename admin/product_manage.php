...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/withChicken/admin/css/product_manage.css">
    <link rel="stylesheet" type="text/css" href="/withChicken/admin/css/prod_manage_inq.css">
    <link rel="stylesheet" type="text/css" href="/withChicken/admin/css/prod_manage_rev.css">
    <link rel="stylesheet" type="text/css" href="/withChicken/admin/css/prod_manage_pur.css">
    <script type="text/javascript" src="https://code.jquery.com/jquery-3.5.1.js"></script>
    <script type="text/javascript" src="/withChicken/admin/js/product_manage.js"></script>
    <script>
        window.onload = function () {
            ready(<?=$pSalePrice?>,<?=$height?>);
            switch(<?=$_GET["page"] ?? 1?>) {
...
<body>
    ...
    <main>
        <div class="main_inner">
                ...
                <div class="prod_info">
                    <div class="prod_info_in">
                        ...
                        <div class="tr">
                            ...
                            <div class="in">
                                <div class="cnt">
                                    <button type="button" onclick="count('minus','<?=$pSalePrice?>');"><img src="./image/minus.jpg"/></button>
                                    <input id="count" type="text" value="1">
                                    <button type="button" onclick="count('plus','<?=$pSalePrice?>');"><img src="./image/plus.jpg"/></button>
                                </div>
                            </div>
                        </div>
                        <div class="option">
                        ...
                        <div class="btn">
                            <div class="update">
                                <button type="button" onclick="location.href='./product_update.php'">수정하기</button>
                            </div>
                            <div class="delete">
                                <button type="button" onclick="product_delete()">삭제하기</button>
                            </div>
                        </div>
                    </div>
                </div>    
            ...
            <?php require("./prod_manage_inq.php"); ?>
            <?php require("./prod_manage_rev.php"); ?>
            <?php require("./prod_manage_pur.php"); ?>
        </div>
    </main>
